...
class SearchEngine:
    ...
    def __init__(self, args):
        ...
        if(self.args.term_weighting == 'glasgow'):
            self.informationRetriever = Glasgow()
        if(self.args.term_weighting == 'glasgow_lsa'):
            self.informationRetriever = GLSAH(k=int(self.args.dim))
        if(self.args.term_weighting == 'normalize'):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-n_gram',  default="hybrid",
